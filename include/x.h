/*
 * @BartoszMilewski's red black tree implementation.
 * Discussed at: https://bartoszmilewski.com/?s=red+black+tree
 * Code at: https://github.com/BartoszMilewski/Okasaki/blob/master/RBTree/RBTree.h
 *
 */
#include "../List/List.h"
#include <cassert>
